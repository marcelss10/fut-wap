...
export async function updateReservation(id, patch) {
  ...
  if (patch.shirtSize !== undefined) dbPatch.shirt_size = patch.shirtSize;
  if (patch.shortsSize !== undefined) dbPatch.shorts_size = patch.shortsSize;
...
// --- Funcoes auxiliares para o botao "Editar Pedido" (nao alteram nada do
// fluxo existente de reserva/admin, apenas leem/atualizam tamanho). ---
